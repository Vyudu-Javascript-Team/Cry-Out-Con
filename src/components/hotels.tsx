      ...
      <div className="container relative max-w-7xl mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto mb-12 bg-white/10 backdrop-blur-sm rounded-xl p-6 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Airfare Discounts</h3>
              <p className="text-sm mb-3 text-white/80">Enter these codes when booking flights on the airline's website or mention them to your travel agent.</p>
              <ul className="space-y-3">
                <li className="flex flex-col sm:flex-row sm:items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="bg-blue-500/20 px-3 py-1 rounded-full text-sm">Discount Code: ZQJQ165702</span>
                    <button 
                ...
                <li className="flex flex-col sm:flex-row sm:items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="bg-blue-500/20 px-3 py-1 rounded-full text-sm">Discount Code: NY3VG</span>
                    <button 
            ...
            <div>
              <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Car Rental Discounts</h3>
              <p className="text-sm mb-3 text-white/80">Use these codes during the reservation process on the rental company's website or at the counter.</p>
              <ul className="space-y-3">
                <li className="flex flex-col sm:flex-row sm:items-center justify-between">
                  <span className="font-medium">Avis</span>
                  <div className="flex items-center gap-2">
                    <span className="bg-blue-500/20 px-3 py-1 rounded-full text-sm">AWD#: Z050846</span>
                    <button 
                ...
                <li className="flex flex-col sm:flex-row sm:items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="bg-blue-500/20 px-3 py-1 rounded-full text-sm">BCD#: V202343</span>
                    <button 
